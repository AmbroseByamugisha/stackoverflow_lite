  ...
  const renderMobileMenu = (
    ...
    >
      ...
      <IconButton
        ...
        <NavLink to="/ask_question" id="post_qn_menu">
          <p>
            Post Question
          </p>
        </NavLink>
      ...
      <IconButton
        ...
        <NavLink to="/login" id="post_qn_menu">
          <p>
            Login
          </p>
        </NavLink>
        ...
        <NavLink to="/signup" id="post_qn_menu">
          <p>
            Signup
          </p>
        </NavLink>
    ...
    <div className={classes.grow}>
      <AppBar position="static">
        <Toolbar>
          ...
          > 
            <NavLink to="/" id="home_icon">
              <HomeIcon />
            </NavLink>
            {/* <MenuIcon /> */}
          </IconButton>
          <NavLink to="/" id="nav_brand">
